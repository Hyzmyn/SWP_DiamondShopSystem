	...
	public class DiamondShopContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Gem>().HasData(
				...
				new Gem { GemID = 2, GemCode = "SAPP-002", GemName = "Sapphire", Origin = "Australia", FourC = 3.8m, Proportion = "VeryGood", Polish = "Excellent", Symmetry = "Very Good", Fluorescence = "Faint", Active = true },
			...
			modelBuilder.Entity<GemPriceList>().HasData(
				new GemPriceList { GemID = 1, CaratWeight = 2.05m, Color = "D", Clarity = "VVS1", Cut = "Excellent", Price = 0m },
				new GemPriceList { GemID = 2, CaratWeight = 1.8m, Color = "E", Clarity = "VS2", Cut = "VeryGood", Price = 0m },
				new GemPriceList { GemID = 3, CaratWeight = 3.02m, Color = "F", Clarity = "IF", Cut = "Good", Price = 0m },
				new GemPriceList { GemID = 4, CaratWeight = 1.2m, Color = "J", Clarity = "SI1", Cut = "Excellent", Price = 0m }
			);

...
namespace Repository.Models
{
    ...
    public class DiamondShopContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Gem>().HasData(
                new Gem { GemID = 1, GemCode = "EMGR-001", GemName = "Emerald", Origin = "Brazil", FourC = 4.5m, Proportion = "Excellent", Polish = "Excellent", Symmetry = "Excellent", Fluorescence = "None", DateTime = DateTime.Parse("2023-01-15"), Active = true },
                new Gem { GemID = 2, GemCode = "SAPP-002", GemName = "Sapphire", Origin = "Australia", FourC = 3.8m, Proportion = "Very Good", Polish = "Excellent", Symmetry = "Very Good", Fluorescence = "Faint", DateTime = DateTime.Parse("2023-01-16"), Active = true },
                new Gem { GemID = 3, GemCode = "DIAM-003", GemName = "Diamond", Origin = "Canada", FourC = 4.9m, Proportion = "Ideal", Polish = "Ideal", Symmetry = "Ideal", Fluorescence = "None", DateTime = DateTime.Parse("2023-01-17"), Active = true },
                new Gem { GemID = 4, GemCode = "RUBY-004", GemName = "Ruby", Origin = "Russia", FourC = 3.2m, Proportion = "Excellent", Polish = "Very Good", Symmetry = "Excellent", Fluorescence = "Faint", DateTime = DateTime.Parse("2023-01-18"), Active = true }
            );
	...
	new Product { ProductID = 1, ProductCode = "P001", ProductName = "Diamond Necklace", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 1, MaterialID = 1, CategoryID = 1, ProductionCost = 150.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 2, ProductCode = "P002", ProductName = "Gold Ring", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 2, MaterialID = 2, CategoryID = 1, ProductionCost = 100.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 3, ProductCode = "P003", ProductName = "Emerald Bracelet", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 3, MaterialID = 3, CategoryID = 1, ProductionCost = 120.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 4, ProductCode = "P004", ProductName = "Silver Earrings", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 4, MaterialID = 4, CategoryID = 1, ProductionCost = 80.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 5, ProductCode = "P005", ProductName = "Sapphire Pendant", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 1, MaterialID = 2, CategoryID = 1, ProductionCost = 130.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 6, ProductCode = "P006", ProductName = "Platinum Bracelet", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 2, MaterialID = 3, CategoryID = 1, ProductionCost = 200.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 7, ProductCode = "P007", ProductName = "Ruby Ring", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 3, MaterialID = 4, CategoryID = 1, ProductionCost = 90.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 8, ProductCode = "P008", ProductName = "Amethyst Earrings", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 4, MaterialID = 1, CategoryID = 1, ProductionCost = 70.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 9, ProductCode = "P009", ProductName = "Topaz Necklace", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 1, MaterialID = 3, CategoryID = 1, ProductionCost = 110.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 10, ProductCode = "P010", ProductName = "Opal Brooch", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 2, MaterialID = 4, CategoryID = 1, ProductionCost = 95.0m, PriceRateID = 1, TotalCost = 0 },

	new Product { ProductID = 11, ProductCode = "P001", ProductName = "Diamond Necklace", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 1, MaterialID = 1, CategoryID = 1, ProductionCost = 150.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 12, ProductCode = "P002", ProductName = "Gold Ring", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 2, MaterialID = 2, CategoryID = 1, ProductionCost = 100.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 13, ProductCode = "P003", ProductName = "Emerald Bracelet", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 3, MaterialID = 3, CategoryID = 1, ProductionCost = 120.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 14, ProductCode = "P004", ProductName = "Silver Earrings", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 4, MaterialID = 4, CategoryID = 1, ProductionCost = 80.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 15, ProductCode = "P005", ProductName = "Sapphire Pendant", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 1, MaterialID = 2, CategoryID = 1, ProductionCost = 130.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 16, ProductCode = "P006", ProductName = "Platinum Bracelet", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 2, MaterialID = 3, CategoryID = 1, ProductionCost = 200.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 17, ProductCode = "P007", ProductName = "Ruby Ring", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 3, MaterialID = 4, CategoryID = 1, ProductionCost = 90.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 18, ProductCode = "P008", ProductName = "Amethyst Earrings", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 4, MaterialID = 1, CategoryID = 1, ProductionCost = 70.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 19, ProductCode = "P009", ProductName = "Topaz Necklace", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 1, MaterialID = 3, CategoryID = 1, ProductionCost = 110.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 20, ProductCode = "P010", ProductName = "Opal Brooch", ImageUrl1 = "1.jpg", ImageUrl2 = "2.jpg", GemID = 2, MaterialID = 4, CategoryID = 1, ProductionCost = 95.0m, PriceRateID = 1, TotalCost = 0 }
);

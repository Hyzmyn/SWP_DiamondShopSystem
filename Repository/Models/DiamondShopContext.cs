...
namespace Repository.Models
{
	...
	new Product { ProductID = 1, ProductCode = "P001", ProductName = "Diamond Necklace", ImageUrl1 = "images/diamond_necklace_1.jpg", ImageUrl2 = "images/diamond_necklace_2.jpg", GemID = 1, Weight = 20.5m, CategoryID = 1, ProductionCost = 150.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 2, ProductCode = "P002", ProductName = "Gold Ring", ImageUrl1 = "images/gold_ring_1.jpg", ImageUrl2 = "images/gold_ring_2.jpg", GemID = 2, Weight = 15.7m, CategoryID = 2, ProductionCost = 100.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 3, ProductCode = "P003", ProductName = "Emerald Bracelet", ImageUrl1 = "images/emerald_bracelet_1.jpg", ImageUrl2 = "images/emerald_bracelet_2.jpg", GemID = 3, Weight = 22.1m, CategoryID = 3, ProductionCost = 120.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 4, ProductCode = "P004", ProductName = "Silver Earrings", ImageUrl1 = "images/silver_earrings_1.jpg", ImageUrl2 = "images/silver_earrings_2.jpg", GemID = 4, Weight = 18.2m, CategoryID = 4, ProductionCost = 80.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 5, ProductCode = "P005", ProductName = "Sapphire Pendant", ImageUrl1 = "images/sapphire_pendant_1.jpg", ImageUrl2 = "images/sapphire_pendant_2.jpg", GemID = 1, Weight = 2.2m, CategoryID = 3, ProductionCost = 130.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 6, ProductCode = "P006", ProductName = "Platinum Bracelet", ImageUrl1 = "images/platinum_bracelet_1.jpg", ImageUrl2 = "images/platinum_bracelet_2.jpg", GemID = 2, Weight = 3.1m, CategoryID = 4, ProductionCost = 200.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 7, ProductCode = "P007", ProductName = "Ruby Ring", ImageUrl1 = "images/ruby_ring_1.jpg", ImageUrl2 = "images/ruby_ring_2.jpg", GemID = 3, Weight = 1.2m, CategoryID = 1, ProductionCost = 90.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 8, ProductCode = "P008", ProductName = "Amethyst Earrings", ImageUrl1 = "images/amethyst_earrings_1.jpg", ImageUrl2 = "images/amethyst_earrings_2.jpg", GemID = 4, Weight = 1.9m, CategoryID = 2, ProductionCost = 70.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 9, ProductCode = "P009", ProductName = "Topaz Necklace", ImageUrl1 = "images/topaz_necklace_1.jpg", ImageUrl2 = "images/topaz_necklace_2.jpg", GemID = 1, Weight = 3.1m, CategoryID = 1, ProductionCost = 110.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 10, ProductCode = "P010", ProductName = "Opal Brooch", ImageUrl1 = "images/opal_brooch_1.jpg", ImageUrl2 = "images/opal_brooch_2.jpg", GemID = 2, Weight = 4m, CategoryID = 2, ProductionCost = 95.0m, PriceRateID = 1, TotalCost = 0 },

	new Product { ProductID = 11, ProductCode = "P001", ProductName = "Diamond Necklace", ImageUrl1 = "images/diamond_necklace_1.jpg", ImageUrl2 = "images/diamond_necklace_2.jpg", GemID = 1, Weight = 1.2m, CategoryID = 1, ProductionCost = 150.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 12, ProductCode = "P002", ProductName = "Gold Ring", ImageUrl1 = "images/gold_ring_1.jpg", ImageUrl2 = "images/gold_ring_2.jpg", GemID = 2, Weight = 2.4m, CategoryID = 2, ProductionCost = 100.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 13, ProductCode = "P003", ProductName = "Emerald Bracelet", ImageUrl1 = "images/emerald_bracelet_1.jpg", ImageUrl2 = "images/emerald_bracelet_2.jpg", GemID = 3, Weight = 3m, CategoryID = 3, ProductionCost = 120.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 14, ProductCode = "P004", ProductName = "Silver Earrings", ImageUrl1 = "images/silver_earrings_1.jpg", ImageUrl2 = "images/silver_earrings_2.jpg", GemID = 4, Weight = 4.5m, CategoryID = 4, ProductionCost = 80.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 15, ProductCode = "P005", ProductName = "Sapphire Pendant", ImageUrl1 = "images/sapphire_pendant_1.jpg", ImageUrl2 = "images/sapphire_pendant_2.jpg", GemID = 1, Weight = 2.5m, CategoryID = 3, ProductionCost = 130.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 16, ProductCode = "P006", ProductName = "Platinum Bracelet", ImageUrl1 = "images/platinum_bracelet_1.jpg", ImageUrl2 = "images/platinum_bracelet_2.jpg", GemID = 2, Weight = 3.1m, CategoryID = 4, ProductionCost = 200.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 17, ProductCode = "P007", ProductName = "Ruby Ring", ImageUrl1 = "images/ruby_ring_1.jpg", ImageUrl2 = "images/ruby_ring_2.jpg", GemID = 3, Weight = 4.1m, CategoryID = 1, ProductionCost = 90.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 18, ProductCode = "P008", ProductName = "Amethyst Earrings", ImageUrl1 = "images/amethyst_earrings_1.jpg", ImageUrl2 = "images/amethyst_earrings_2.jpg", GemID = 4, Weight = 1.8m, CategoryID = 2, ProductionCost = 70.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 19, ProductCode = "P009", ProductName = "Topaz Necklace", ImageUrl1 = "images/topaz_necklace_1.jpg", ImageUrl2 = "images/topaz_necklace_2.jpg", GemID = 1, Weight = 3.5m, CategoryID = 1, ProductionCost = 110.0m, PriceRateID = 1, TotalCost = 0 },
	new Product { ProductID = 20, ProductCode = "P010", ProductName = "Opal Brooch", ImageUrl1 = "images/opal_brooch_1.jpg", ImageUrl2 = "images/opal_brooch_2.jpg", GemID = 2, Weight = 2.6m, CategoryID = 2, ProductionCost = 95.0m, PriceRateID = 1, TotalCost = 0 }
);
